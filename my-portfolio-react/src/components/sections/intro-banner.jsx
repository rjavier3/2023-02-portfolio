        ...
        <div className="row">
          <div className="col-lg-9">
            <div className="caption center mt-50">
              ...
              <p>If you are in need of an online presence for your portfolio, require a platform to build your online store, or are looking for a front-end developer to join your team, I am here to help.</p>
